    ...
    return (
        <div className="flex flex-row items-start gap-5">
            <div className="flex w-3/4 flex-col gap-5">
                <p className="text-[2rem] font-semibold">Откликнувшиеся кондидаты</p>
                <Link href={'/hr/candidates/reg32'} className="flex w-full flex-col gap-6 rounded-2xl bg-white p-6 shadow-md">
                    {/* Header */}
                ...
                <div className="flex w-full flex-col gap-6 rounded-2xl bg-white p-6 shadow-md">
                    <p className="text-xl font-bold text-[#814BFF]">
                        Другие рекомендованные сотрудники на основе ИИ
                    </p>
...
export default CondidatResumeCard;
